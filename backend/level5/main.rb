...
GPS = 500             # => (euros cents/day, money goes to the owner)
BABY_SEAT = 200       # =>(euros cents/day, money goes to the owner)
ADD_INSURANCE = 1000  # => (euros cents/day, money goes to the drivy)
